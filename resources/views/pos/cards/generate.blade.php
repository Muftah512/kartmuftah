...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
            <h1 class="text-2xl font-bold text-white">ÊæáíÏ ßÑÊ ÅäÊÑäÊ ÌÏíÏ</h1>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('pos.cards.generate.submit') }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="package_id" class="block text-gray-700 font-medium mb-2">ÇÎÊÑ ÇáÈÇÞÉ</label>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 mt-1">ÓíÊã ÅÑÓÇá ÇáßÑÊ ÊáÞÇÆíÇð ÚÈÑ æÇÊÓÇÈ áåÐÇ ÇáÑÞã</p>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                ÇáÑÕíÏ ÇáÍÇáí: <span class="font-bold">{{ number_format($balance) }} ÑíÇá íãäí</span>
                            </p>
                        </div>
                    </div>
                </div>
